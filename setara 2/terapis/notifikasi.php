...
<head>
    ...
    <title>Notifikasi Terapis - Setara Kids</title>
    <!-- Fonts -->
                                ...
                                <div class="list-group list-group-flush">
                                    <a href="#" class="list-group-item list-group-item-action">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1 text-primary">Jadwal Baru Ditambahkan</h5>
                                            <small>3 hari yang lalu</small>
                                        </div>
                                        <p class="mb-1">Admin telah menambahkan jadwal baru untuk Ananda Bima di hari Senin.</p>
                                    </a>
                                    <a href="#" class="list-group-item list-group-item-action">
                                        <div class="d-flex w-100 justify-content-between">
                                        ...
                                        <p class="mb-1">Laporan bulanan Ananda Ayu telah disetujui oleh Orangtua.</p>
                                    </a>
                                    <a href="#" class="list-group-item list-group-item-action">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1 text-warning">Pengingat Absensi</h5>
                                            <small>2 minggu yang lalu</small>
                                        </div>
                                        <p class="mb-1">Jangan lupa mengisi absensi harian sebelum pukul 16:00 WITA.</p>
                                    </a>
                                </div>
                            </div>
                        </div>
