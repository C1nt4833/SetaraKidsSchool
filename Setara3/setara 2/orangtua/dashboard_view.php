...
<head>
    <meta charset="utf-8">
    <title>Dashboard Orang Tua - Setara Kids School</title>
    ...
    <style>
        ...
        .sidebar-brand h3 {
            color: var(--primary); /* Mengambil warna dari style.css */
            font-size: 1.25rem;
            margin: 0;
            font-weight: 700;
        }
        ...
        .user-img-circle {
            width: 80px;
            height: 80px;
            background-color: #e0f7fa; /* Light cyan/blue variant for differentiator if needed, or stick to theme */
            background-color: #ffe5d9; /* Keeping consistent with theme */
            color: var(--primary);
            border-radius: 50%;
            display: flex;
            align-items: center;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-welcome">
                        ...
                        <p class="text-secondary mb-0">Pantau perkembangan belajar dan kehadiran anak Anda secara real-time.</p>
                    </div>
                </div>
            </div>
        </div>
